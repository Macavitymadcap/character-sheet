...
The Friday operator boundary is recorded in [Rovnost Friday Readiness Acceptance](./docs/operations/rovnost-friday-readiness-acceptance.md):
take a hosted backup, import `/data/private-rules`, run the Rovnost coverage report, check `/readyz`,
and treat character creation, levelling, combat tracking, and Qor'thos wiki work as deferred unless
later tickets complete them.
